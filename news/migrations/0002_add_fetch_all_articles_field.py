...
class Migration:
    ...
    def forwards(self, orm):
        # Adding field 'Feed.fetch_all_articles'
        db.add_column('news_feed', 'fetch_all_articles', orm['news.feed:fetch_all_articles'])

    def backwards(self, orm):
        # Deleting field 'Feed.fetch_all_articles'
        db.delete_column('news_feed', 'fetch_all_articles')
    ...
    models = {
        ...
        'news.category': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'children'", 'blank': 'True', 'null': 'True', 'to': "orm['news.Category']"}),
